# Banka Müşteri Terk (Churn) Analizi
...
- **Microsoft Excel:** Veri temizleme, filtreleme ve manipülasyon.
- **Pivot Tablolar (Özet Tablolar):** Müşteri segmentlerini karşılaştırmalı analiz etmek için kullanıldı.
- **Veri Görselleştirme:** Risk gruplarının dağılımını göstermek için grafikler oluşturuldu.

## 📈 Önemli Bulgular
*Aktif üyelerin (IsActiveMember) terk etme oranının, pasif üyelere göre daha düşük olduğu gözlemlenmiştir.*
